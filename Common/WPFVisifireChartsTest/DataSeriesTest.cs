...
namespace WPFVisifireChartsTest
{
    ...
    {
        #region DataSeriesColumnChecking
        /// <summary>
        ...
        #region MultiSeriesBarChartChecking
        /// <summary>
        ...
        public void CheckLineThicknessDefaultPropertyValue()
        {
            ...
            if (_isLoaded)
            {
                Assert.AreEqual(((chart.ActualWidth * chart.ActualHeight) + 25000) / 35000 > 3 ? 3 : ((chart.ActualWidth * chart.ActualHeight) + 25000) / 35000, (Double)dataSeries.LineThickness, Common.HighPrecisionDelta);
            }
            window.Dispatcher.InvokeShutdown();
            window.Close();
        }
        ...
        /// <summary>
        /// Create DataSeries with ZValues
        /// </summary>
        /// <returns></returns>
