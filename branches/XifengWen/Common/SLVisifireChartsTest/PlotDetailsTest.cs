...
{
    //[TestClass]
    public class PlotDetailsTest : SilverlightControlTest
    {
        ...
        //        plotDetails.PlotGroups.Add(pg);
        //        //plotDetails.PlotGroups[0].DataSeriesList = new List<DataSeries>();
        ...
        //    EnqueueConditional(new ConditionDelegate(delegate { return isLoaded; }));
